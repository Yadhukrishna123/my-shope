        ...
        <div className="subSession">
          ...
          <div className='ms-auto text-center mt-4'>
            <Link style={{ textDecoration: "none" }} to="/">
              <p onClick={handleFooter}>Home</p>
            </Link>

            <Link style={{ textDecoration: "none" }} to="/about">
              <p onClick={handleFooter}>About</p>
            </Link>
            <Link style={{ textDecoration: "none" }} to={user ? `/account/${user._id}` : "/login"}>
              <p onClick={handleFooter}>My Account</p>
            </Link>
            <Link style={{ textDecoration: "none" }} to="/cart">
              <p onClick={handleFooter}>Cart</p>
            </Link>
            <Link style={{ textDecoration: "none" }} to="/contact">
              <p onClick={handleFooter}>Contact</p>
            </Link>
